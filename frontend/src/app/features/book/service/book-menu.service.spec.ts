...
describe('BookMenuService', () => {
  it.todo('needs dialog seams to verify delete, merge, send, rescan, and metadata-refresh action branching');
  it.todo('needs loader and toast seams to verify success, failure, and bulk-operation messaging paths');
});
