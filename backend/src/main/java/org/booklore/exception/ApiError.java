...
public enum ApiError {
    ...
    DOCUMENT_UNREADABLE(HttpStatus.UNPROCESSABLE_ENTITY, "Document cannot be read"),
    ...
    RECOMMENDATION_QUEUE_FULL(HttpStatus.SERVICE_UNAVAILABLE, "Book recommendation queue is full. Please try again later."),
    INPX_ARCHIVE_SCAN_QUEUE_FULL(HttpStatus.SERVICE_UNAVAILABLE, "INPX archive scan queue is full. Please try again later."),
